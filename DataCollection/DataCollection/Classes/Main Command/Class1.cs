   ...
   public class Layers
    {
        ...
        public static void Main()
        {
            ...
            var LayerName = Classes.Data.GetLayers.GetLayerName();

            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Water", DocName);
            ...
            LayerName = Classes.Data.GetLayers.GetLayerName();

            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Sewer", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Drain", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Bkerb", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Ikerb", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Pboundary", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Sboundary", DocName);
            ...
            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "Hydrant", DocName);

            //Add hydrant layers to the overall list
            LayersTotal.AddRange(LayerName);

            //Get HV poles layer name//
            Application.ShowAlertDialog("\nSelect a HV pole: ");
            LayerName = Classes.Data.GetLayers.GetLayerName();

            Classes.Data.CollectInfo.LayerInfoGrab(LayerName, "HVpole", DocName);

            //Add HV pole layers to the overall list
            LayersTotal.AddRange(LayerName);
        }
    }
}
